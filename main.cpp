// Sergio Alberto Giraldo Salazar y Ricardo Echeverri Cano
...
int main() {
    while (true) {
        ...
        unsigned long long int A, B, C, remainder, division, result, counter, other_N, digit, first_operand, second_operand, money, wanting, mid, column, other_counter;
